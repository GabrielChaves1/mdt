import{s as o,C as h,Z as m,a as e,d as r,j as n,I as i,T as s,b as a,g as l}from"./index-b704f29e.js";import{P as d}from"./plus-464a9d22.js";const p=o(h)`
  display: flex;
...
`;function v(){const{colors:t}=m();return e(u,{children:e(r.Root,{children:e(r.Content,{children:n(f,{children:[n(i.Root,{children:[e(i.Header,{children:e(i.Label,{children:"Infrator"})}),e(i.Content,{children:e(s,{placeholder:"Nenhum infrator anexado"})})]}),n(i.Root,{children:[e(i.Header,{children:e(i.Label,{children:"Imagens do infrator"})}),e(i.Content,{children:n(C,{children:[e(c,{children:e(d,{size:34,strokeWidth:1.5,color:a(.6,t.icon)})}),e(c,{children:e(d,{size:34,strokeWidth:1.5,color:a(.6,t.icon)})}),e(c,{children:e(d,{size:34,strokeWidth:1.5,color:a(.6,t.icon)})})]})})]})]})})})})}const x=o.div`
  grid-area: policers;
`,S=o.div`
  width: 100%;
  height: 100%;
